...
use App\Http\Controllers\AccountingRuleController;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/partners/{partner}/statement', [PartnerController::class, 'downloadStatement'])->name('partnersStatement');
